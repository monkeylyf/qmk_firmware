...
[_BASE] = {
  ...
  {FUNC,    KC_LCTL, KC_LALT, KC_LGUI, SYMB,  KC_BSPC, KC_ENT,  KC_SPC,  KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC}
},
...
[_SYMB] = {
  ...
  {_______, KC_TILD, KC_PIPE, KC_PLUS, KC_LBRC, KC_RBRC, KC_RCBR, KC_RBRC, KC_EQL,  KC_BSLS, KC_GRV,  _______},
  {_______, _______, _______, _______, _______, KC_BSPC, KC_ENT,  KC_SPC,  _______, _______, _______, _______}
},
