...
[_QWERTY] = {
  ...
  {SFT_TAB, KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_GRV },
  {FUNC,    KC_LCTL, KC_LALT, GUI_MINS, KC_BSPC, KC_ESC, KC_ENT, KC_SPC, KC_EQL,  _______, _______, _______}
},
